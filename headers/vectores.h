...
void leerVector(string nombre,string vectCategorias[],int vectJugador[], int size);   // Lee vector
...
void leerVector(string nombre,string vectCategorias[], int vectJugador[], int size){
        cout<<" ----------------"<<endl;
